...
async function updateUsageCount(client: MongoClient, translator: string, usage: any) {
    const result = await client.db("Zekuru").collection("TranslationUsage").updateOne(
        {
